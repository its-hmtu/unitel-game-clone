...
const OtherGames = ({ gameList, roomId }) => {
  ...
  useEffect(() => {
    ...
    else setList(gameList?.filter((item) => item.id != roomId));
  }, [searchValue]);
  ...
  return (
    <Container fluid className="other-game">
      ...
      {list?.length > 0 ? (
        ...
        <Row className="mt-1 g-3 overflow-hidden">
          <Col className="pe-2 px-0 px-sm-2 col-lg-3 col-sm-6 col-6">
...
export default memo(OtherGames);
