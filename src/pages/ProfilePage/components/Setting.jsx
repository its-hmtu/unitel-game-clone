...
const Setting = () => {
  ...
  return (
    <>
      ...
      <Row className='profile-page-content__body setting mt-3'>
      ...
      <Row className="profile-page-content__title mt-4">
				{t('profile.setting.lang')}
			</Row>
      <Row className='profile-page-content__body setting my-3'>
        <Row
					className="content"
					onClick={() => {
						changeLanguage('en')
